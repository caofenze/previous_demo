...
!function(WIN, DOC, $, undef) {
    ...
    $ = $ || window.require && require("buy:widget/ui/jquery/jquery.js");

    if (!$) return;
    var noop = function() {}
        , replaceTpl = window.require && require("buy:widget/ui/helper/helper.js").replaceTpl || function(tpl, data, label) {
            var s = label || /#\{([^}]*)\}/mg,
                trim = function (str) {
