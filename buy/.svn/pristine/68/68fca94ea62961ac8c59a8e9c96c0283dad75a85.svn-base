var $ = require("buy:widget/ui/jquery/jquery.js"),
	__date = require("buy:widget/ui/date/date.js"),
	time = require("buy:widget/ui/time/time.js"),
	UT = require("buy:widget/ui/ut/ut.js");
require("buy:widget/ui/date-new/date.js");
...
var calenTpl = '<div class="ui-bubble ui-bubble-t mod-calendar"><div class="mod-calendar_hd"><span class="mod-calendar_next">→</span><span class="mod-calendar_prev">←</span><select class="mod-calendar_year" id="calYear"></select><select class="mod-calendar_month" id="calMonth"></select></div><div class="mod-calendar_bd"><ul class="mod-calendar_grid mod-calendar_weeks cf"></ul><ul class="mod-calendar_grid mod-calendar_days cf"></ul></div><div class="mod-calendar_splt"></div><div class="mod-calendar_ft"></div></div>',
    ...
    getItemData = function(y, M, d) {
    	...
    	obj = events[str] || holiday[str] || festival[str] || normal[str] || null;
    	if(obj) {
    		if(obj.kind) {
...
var init = function($glo, moreBtn, url, _co, week) {
	...
	if (seCalen && calenPath[seCalen]) {
		if (calenPath[seCalen] === "rokuyou") {
			require.async(["buy:widget/ui/calendar/calendar.js", "buy:widget/ui/date-new/plugin/rokuyou.js"], function() {
				callback($glo, moreBtn, url, _co, week);
			});
		} else if (calenPath[seCalen] === "isl") {
			require.async(["buy:widget/ui/calendar/calendar.js", "buy:widget/ui/date-new/plugin/isl.js"], function() {
				callback($glo, moreBtn, url, _co, week);
			});
		} else if (calenPath[seCalen] === "buddhist") {
			require.async(["buy:widget/ui/calendar/calendar.js", "buy:widget/ui/date-new/plugin/buddhist.js"], function() {
				callback($glo, moreBtn, url, _co, week);
			});
		} else if (calenPath[seCalen] === "lunar") {
			require.async(["buy:widget/ui/calendar/calendar.js", "buy:widget/ui/date-new/plugin/lunar.js"], function() {
				callback($glo, moreBtn, url, _co, week);
			});
		}
	} else {
		require.async(["buy:widget/ui/calendar/calendar.js"], function() {
			callback($glo, moreBtn, url, _co, week);
		});
	}
};
