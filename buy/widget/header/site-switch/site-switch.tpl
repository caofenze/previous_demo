...
<%*   声明对ltr/rtl的css依赖    *%>
<%if $head.dir=='ltr'%> 
  <%require name="buy:widget/header/site-switch/ltr/ltr.more.css"%> 
<%else%> 
  <%require name="buy:widget/header/site-switch/rtl/rtl.more.css"%> 
<%/if%>

<div class="settings">
	<span class="settings-btn" id="settingBtn"><span class="btn-holder"></span></span>
	<div class="settings-dropdown" id="settingDropdown">
...
<%script%>
	require.async("buy:widget/header/site-switch/site-switch-async.js");
<%/script%>
