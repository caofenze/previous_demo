...
require("buy:widget/ui/jquery/widget/jquery.addfav/jquery.addfav.js");
...
var _browser     = _conf.browser,
    ...
    _itemTpl     = '<div class="btn-item"><a href="#{url}" id="#{id}" class="btn-item-anchor"#{retrn}>#{content}</a><div class="btn-item-tips"><p id="#{botId}">#{botContent}</p></div></div>',
    _itemMsg     = {
        addfav: {
            'url': _addfav.url,
            'id': 'addFav',
